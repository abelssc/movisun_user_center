...
const Orders = () => {
  ...
  return (
    <Layout>
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 overflow-x-scroll lg:overflow-x-auto lg:min-w-96 max-w-screen-2xl mx-auto">
        ...
        <ul className="flex gap-4 mb-6 justify-between font-medium max-w-screen-lg mx-auto">
          ...
          <li>
            <Link to="?page=1&state=-10" className={filters.state === "-10" ? "text-gray-700 dark:text-gray-50" : "text-gray-500 dark:text-gray-400"}>
              Pedidos Cancelados
            </Link>
          </li>
        </ul>
